...
class NewsRepository {
  ...
  Future<CategoriesNewsModel> fetchNewsCategoires(String category) async {
    String newsUrl =
        'https://newsapi.org/v2/everything?q=$category&apiKey=c4561371de814f679616c0c0e80d3767';
  ...
  Future<NewsChannelHeadlinesModel> fetchNewsChannelHeadlinesApi(String newsChannel) async {
    String newsUrl = 'https://newsapi.org/v2/top-headlines?sources=${newsChannel}&apiKey=c4561371de814f679616c0c0e80d3767';
    print(newsUrl);
    final response = await http.get(Uri.parse(newsUrl));
